...
const copies = {
  en: {
    ...
    actions: {
      ...
      retryStrategies: 'Retry loading strategies',
      viewResult: 'View stability report',
    },
    states: {
      loadingDatasets: 'Loading historical datasets...',
      loadingStrategies: 'Loading research strategies...',
      ...
      strategyLoadError: 'Research strategy metadata could not be loaded.',
    ...
    errors: {
      ...
      strategyUnavailable: 'The selected research strategy metadata is unavailable.',
      invalidFastPeriod:
        'Fast moving-average period must be an integer greater than or equal to 2.',
      invalidSlowPeriod:
        'Slow moving-average period must be an integer greater than or equal to 3.',
      slowMustBeGreater:
  ...
  fa: {
    ...
    fields: {
      ...
      strategy: 'استراتژی',
      mode: 'نوع پنجره',
      fastPeriod: 'دوره میانگین متحرک سریع',
      slowPeriod: 'دوره میانگین متحرک آهسته',
      rsiPeriod: 'دوره RSI',
    ...
    actions: {
      ...
      retryStrategies: 'تلاش مجدد برای دریافت استراتژی‌ها',
      viewResult: 'مشاهده گزارش پایداری',
    },
    states: {
      loadingDatasets: 'در حال دریافت دیتاست‌های تاریخی...',
      loadingStrategies: 'در حال دریافت استراتژی‌های پژوهشی...',
      ...
      strategyLoadError: 'دریافت فراداده استراتژی‌های پژوهشی امکان‌پذیر نبود.',
    ...
    errors: {
      ...
      strategyUnavailable: 'فراداده استراتژی پژوهشی انتخاب‌شده در دسترس نیست.',
      invalidFastPeriod: 'دوره میانگین متحرک سریع باید عدد صحیح و حداقل ۲ باشد.',
      invalidSlowPeriod: 'دوره میانگین متحرک آهسته باید عدد صحیح و حداقل ۳ باشد.',
      slowMustBeGreater: 'دوره میانگین متحرک آهسته باید از دوره میانگین متحرک سریع بزرگ‌تر باشد.',
