...
| --- | --- | --- | --- | --- |
| D01 | حداقل یک Connection دادهٔ واقعی Test و Historical Import انجام دهد. | allowlist شامل Binance، Nobitex و Kraken است؛ adapterهای Nobitex و Kraken با fixture آفلاین، حذف کندل باز و محدودیت عمق صریح اضافه شده‌اند. شواهد اجرای واقعی هنوز باید هنگام پذیرش SHA نهایی ثبت شوند. | Nobitex مستقیم و Kraken روی مسیر VPN را health-check کن؛ بازهٔ معلوم را وارد و provenance، coverage، خطای provider/timeout و نبود secret را کنترل کن. | TB2-003، TB2-003.5A تا C، TB2-004، TB2-009 |
